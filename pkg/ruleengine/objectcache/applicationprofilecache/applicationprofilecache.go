...
func (ap *ApplicationProfileCacheImpl) ModifyHandler(ctx context.Context, obj *unstructured.Unstructured) {
	...
	case "Pod":
		// do nothing
	case "ApplicationProfile":
		ap.modifyApplicationProfile(ctx, obj)
	}
}
...
func (ap *ApplicationProfileCacheImpl) addApplicationProfile(ctx context.Context, obj *unstructured.Unstructured) {
...
func (ap *ApplicationProfileCacheImpl) modifyApplicationProfile(ctx context.Context, obj *unstructured.Unstructured) {
	apName := objectcache.UnstructuredUniqueName(obj)
