...
func (rl *reparentingLogicImpl) Reparent(exitingPID uint32, children []*armotypes.Process, containerTree containerprocesstree.ContainerProcessTree, processMap *maps.SafeMap[uint32, *armotypes.Process]) (uint32, error) {
	rl.mutex.Lock()
...
func (rl *reparentingLogicImpl) getSelectedStrategy(exitingPID uint32, containerTree containerprocesstree.ContainerProcessTree, processMap *maps.SafeMap[uint32, *armotypes.Process]) ReparentingStrategy {
