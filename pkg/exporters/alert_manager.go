	...
	myAlert := models.PostableAlert{
		...
		Alert: models.Alert{
			...
			Labels: map[string]string{
				...
				"pod_uid":           failedRule.GetRuntimeAlertK8sDetails().PodUID,
				"workload_uid":      failedRule.GetRuntimeAlertK8sDetails().WorkloadUID,
				"host":              ame.Host,
	...
	myAlert := models.PostableAlert{
		...
		Alert: models.Alert{
			...
			Labels: map[string]string{
				...
				"pod_uid":                malwareResult.GetRuntimeAlertK8sDetails().PodUID,
				"workload_uid":           malwareResult.GetRuntimeAlertK8sDetails().WorkloadUID,
