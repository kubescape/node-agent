# Host FIM Sensor
This package provides File Integrity Monitoring (FIM) functionality for the Kubescape Node Agent. The implementation has been migrated from `fsnotify` to `fanotify` to provide better subdirectory monitoring support.
