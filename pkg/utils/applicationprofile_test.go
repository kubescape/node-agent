...
func Test_EnrichApplicationProfileContainer(t *testing.T) {
	...
	// empty enrich
	EnrichContainerProfileSpec(existingContainer, []string{}, []string{}, map[string][]string{}, map[string]mapset.Set[string]{}, test, map[string]v1beta1.RulePolicy{}, []v1beta1.IdentifiedCallStack{}, "", "")
	...
	EnrichContainerProfileSpec(existingContainer, []string{"SETGID"}, []string{"listen"}, map[string][]string{}, map[string]mapset.Set[string]{}, test, map[string]v1beta1.RulePolicy{}, []v1beta1.IdentifiedCallStack{}, "", "")
	assert.Equal(t, 5, len(existingContainer.Capabilities))
	assert.Equal(t, 2, len(existingContainer.Execs))
	assert.Equal(t, 5, len(existingContainer.Syscalls))
	assert.Equal(t, 0, len(existingContainer.Opens))
	...
	EnrichContainerProfileSpec(existingContainer, []string{"NEW"}, []string{"xxx", "yyy"}, map[string][]string{}, map[string]mapset.Set[string]{}, test, map[string]v1beta1.RulePolicy{}, []v1beta1.IdentifiedCallStack{}, "", "")
	...
	EnrichContainerProfileSpec(existingContainer, []string{"NEW"}, []string{"xxx", "yyy"}, map[string][]string{}, opens, test, map[string]v1beta1.RulePolicy{}, []v1beta1.IdentifiedCallStack{}, "", "")
	assert.Equal(t, 6, len(existingContainer.Capabilities))
	assert.Equal(t, 2, len(existingContainer.Execs))
	assert.Equal(t, 7, len(existingContainer.Syscalls))
