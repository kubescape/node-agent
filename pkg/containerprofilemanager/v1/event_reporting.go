...
func (cpm *ContainerProfileManager) ReportNetworkEvent(containerID string, event *datasource.Data) {
...
//func (cpm *ContainerProfileManager) isValidNetworkEvent(event *datasource.Data) bool {
