...
func (cpm *ContainerProfileManager) ReportNetworkEvent(containerID string, event *utils.EnrichEvent) {
...
func (cpm *ContainerProfileManager) isValidNetworkEvent(event *utils.EnrichEvent) bool {
	pktType := event.GetPktType()
