...
// read_tty is backported from Inspektor Gadget commit c6fc831a. The
// v0.48.1 argument collection remains unchanged so existing profile argument
// matching continues to use the execve pathname as args[0].
//
...
// terminal. The device number identifies the terminal unambiguously.
