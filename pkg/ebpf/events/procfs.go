...
func (pe *ProcfsEvent) GetContainer() string {
	return ""
}
...
func (pe *ProcfsEvent) GetContainerImage() string {
	return ""
}

func (pe *ProcfsEvent) GetContainerImageDigest() string {
	return ""
}

func (pe *ProcfsEvent) GetHostNetwork() bool {
	return false
}
