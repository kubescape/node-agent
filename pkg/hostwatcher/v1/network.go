...
func (ch *IGHostWatcher) networkEventCallback(event *tracernetworktypes.Event) {
...
func (ch *IGHostWatcher) startNetworkTracing() error {
	...
	if ch.socketEnricher != nil {
		...
		logger.L().Error("IGHostWatcher - socket enricher is nil")
	}
...
// func (ch *IGHostWatcher) startKubernetesResolution() error {
...
func (ch *IGHostWatcher) stopNetworkTracing() error {
	// Stop network tracer
