...
func (ch *IGHostWatcher) httpEventCallback(event *tracerhttptype.Event) {
...
func (ch *IGHostWatcher) startHttpTracing() error {
...
func (ch *IGHostWatcher) stopHttpTracing() error {
