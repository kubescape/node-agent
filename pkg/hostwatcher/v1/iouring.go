...
func (ch *IGHostWatcher) iouringEventCallback(event *traceriouringtype.Event) {
...
func (ch *IGHostWatcher) startIouringTracing() error {
...
func (ch *IGHostWatcher) stopIouringTracing() error {
