...
func (ch *IGHostWatcher) symlinkEventCallback(event *tracersymlinktype.Event) {
...
func (ch *IGHostWatcher) startSymlinkTracing() error {
...
func (ch *IGHostWatcher) stopSymlinkTracing() error {
	// Stop symlink tracer
