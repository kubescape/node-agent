...
func (ch *IGHostWatcher) hardlinkEventCallback(event *tracerhardlinktype.Event) {
...
func (ch *IGHostWatcher) startHardlinkTracing() error {
...
func (ch *IGHostWatcher) stopHardlinkTracing() error {
