...
func (ch *IGHostWatcher) execEventCallback(event *tracerexectype.Event) {
...
func (ch *IGHostWatcher) startExecTracing() error {
	...
	tracerExec, err := tracerexec.NewTracer(&tracerexec.Config{MountnsMap: execMountnsmap, GetPaths: true}, nil, ch.execEventCallback)
	if err != nil {
...
func (ch *IGHostWatcher) stopExecTracing() error {
	// Stop exec tracer
