...
func TestApplicationProfileManager(t *testing.T) {
	...
	assert.Equal(t, []string{"NET_BIND_SERVICE"},
		storageClient.ApplicationProfiles[0].Spec.Capabilities)
