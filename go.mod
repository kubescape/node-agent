...
require (
	...
	github.com/kubescape/k8s-interface v0.0.165-0.20240404093458-3aea7e70c96f
	github.com/kubescape/storage v0.0.75-0.20240404083747-c3e80ea669ea
...
require (
	...
	github.com/anchore/syft v1.1.0 // indirect
