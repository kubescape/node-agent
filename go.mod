...
require (
	...
	github.com/armosec/armoapi-go v0.0.648
...
replace github.com/inspektor-gadget/inspektor-gadget => github.com/matthyx/inspektor-gadget v0.0.0-20251107125442-9cb292126068
