...
require (
	...
	github.com/kubescape/storage v0.0.112-0.20240909133306-9055d6816ff5
...
require (
	...
	github.com/wagoodman/go-progress v0.0.0-20230925121702-07e42b3cdba0 // indirect; indirects
