...
func main() {
	...
	if cfg.EnableRuntimeDetection {
		// create exporter
		exporter := exporters.InitExporters(cfg.Exporters, clusterData.ClusterName, cfg.NodeName, cloudMetadata, clusterUID, apitypes.AlertSourcePlatformK8sAgent)
	...
	if cfg.EnableFIM {
		...
		fimExporter := exporters.InitExporters(fimExportersConfig, clusterData.ClusterName, cfg.NodeName, cloudMetadata, clusterUID, apitypes.AlertSourcePlatformK8sAgent)
